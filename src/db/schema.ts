...
// agents drove it), actions (every control-plane request, in order), images
// (the PNG each get-image returned), and logs (debug lines from db.log,
// each pinned to a session and an agent when the writer had them).
//
