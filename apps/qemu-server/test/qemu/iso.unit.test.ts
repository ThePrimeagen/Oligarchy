...
type Fixture = {
  ...
  readonly intercepted: TestingFs.Intercepted;
...
const manifestWrites = (calls: ReadonlyArray<TestingFs.Call>): ReadonlyArray<string> =>
  calls
...
const progressLines = (log: TestingLog.FakeLog): ReadonlyArray<string> =>
